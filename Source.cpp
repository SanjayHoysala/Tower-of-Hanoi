...
void first()
{
	...
	glColor3f(1,0,0);
	strokeString(50,850,0.15,0.15,"SJB INSTITUTE OF TECHNOLOGY",2);
	...
	glColor3f(1,1,0);
	strokeString(650,160,0.18,0.18,"Santhosh K S",2);
	glColor3f(1,0,0);
	strokeString(650,20,0.18,0.18,"1JB16CS145",2);
	glColor3f(1,0,0);
	strokeString(650,120,0.18,0.18,"1JB16CS146",2);
	glColor3f(1,1,0);
	strokeString(650,60,0.18,0.18,"Sanjay K hoysala",2);	
	glutSwapBuffers();
}
